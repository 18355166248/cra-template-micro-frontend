import { getPage } from '@/services/contract-service';
...
interface ContractManageInterface {
  modalShow: boolean;
  filterParams: any;
...
class ContractManageModels implements ContractManageInterface {
  filterParams: any;
  modalShow: boolean;
  pagination: Pagination;
  modalOption: any;
...
export const store = new ContractManageModels();
